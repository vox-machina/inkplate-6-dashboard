...
#define TIME_TO_SLEEP  180      // How long ESP32 will be in deep sleep (in seconds) - edit accordingly to your use
...
const char *dashboard-uri = ""; // The URI to your dashboard image
...
// Edit below to provide the location of your jpg to display
    ...
    if (!display.drawImage(dashboard-uri, 0, 0, true, false))
    {
